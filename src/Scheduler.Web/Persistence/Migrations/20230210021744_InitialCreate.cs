...
{
	/// <summary>
	/// Moves the database to the new migration.
	/// </summary>
	/// <param name="migrationBuilder">For configuring the migration.</param>
	...
	/// <summary>
	/// Prepares the previous database for migration.
	/// </summary>
	/// <param name="migrationBuilder">For configuring mthe migration.</param>
